...
function renderRows(items) {
    ...
    tableBody.innerHTML = items.map((item) => {
        ...
        const slowMarker = responseTimeMs != null && responseTimeMs > SLOW_RESPONSE_THRESHOLD_MS
            ? '<span class="slow-alert" title="Slow response (>3000 ms)">!</span>'
            : "";
        ...
        return `
            <tr>
                ...
                <td>${escapeHtml(responseTime)} ${slowMarker}</td>
